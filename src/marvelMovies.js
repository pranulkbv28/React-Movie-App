let marvelMovies = [
    {
      ...
      year: 2008,
      description:
        "Billionaire Tony Stark builds a powered suit of armor and becomes Iron Man.",
      genre: "Action",
    ...
    },
    {
      ...
      year: 2016,
      description:
        "A former neurosurgeon embarks on a journey of healing and discovery as the Sorcerer Supreme of the mystical arts.",
      genre: "Action",
    ...
    },
    {
      ...
      year: 2014,
      description:
        "Steve Rogers teams up with Natasha Romanoff to stop a powerful enemy known as the Winter Soldier.",
      genre: "Action",
    ...
    },
    {
      ...
      year: 2015,
      description:
        "Armed with a super-suit with the astonishing ability to shrink in scale but increase in strength, Scott Lang must embrace his inner hero.",
      genre: "Action",
